      ...
      <main>
          ...
          <div className="hero-grid">
            <div className="hero-copy reveal">
              ...
              <div className="hero-actions">
                ...
                >
                  {t.hero.projects} <span>&rarr;</span>
                </button>
                <a
                ...
                >
                  {t.hero.resume} <span>&darr;</span>
                </a>
                <button
                  className="text-link"
                  onClick={() => navigate("contact")}
                >
                  {t.hero.contact} <span>&rarr;</span>
                </button>
              </div>
        ...
        <section id="experience" className="section-pad">
          ...
          <div className="timeline reveal">
            <article className="timeline-item">
              <div className="timeline-date">{t.experience.silverDate}</div>
              <div>
                <p className="role-company">{t.experience.silverland}</p>
                <h3>{t.experience.silverRole}</h3>
                <ul>
                  {t.experience.silverBullets.map((bullet) => (
            ...
            <article className="timeline-item">
              <div className="timeline-date">{t.experience.techDate}</div>
              <div>
                <p className="role-company">{t.experience.techinika}</p>
                <h3>{t.experience.techRole}</h3>
                <ul>
                  {t.experience.techBullets.map((bullet) => (
                    <li key={bullet}>{bullet}</li>
                  ))}
                </ul>
              </div>
              ...
              <article className="project-card reveal" key={project.title}>
                ...
                {project.github && (
                  <a
                    ...
                    rel="noreferrer"
                  >
                    {t.projects.viewGithub} <span>&rarr;</span>
                  </a>
                )}
              </article>
            ))}
        ...
        <section id="skills" className="section-pad">
          ...
          <div className="cert-row reveal">
            <div>
              <span className="eyebrow">{t.skills.learning}</span>
              <h3>{t.skills.certifications}</h3>
            </div>
            <div className="cert-list">
              {t.skills.certificates.map((certificate) => (
            ...
            <div className="reveal">
              ...
              <div className="contact-links">
                <a href={`mailto:${t.contact.email}`}>
                  {t.contact.email} <span>&rarr;</span>
                </a>
                <a href={socials[1].href} target="_blank" rel="noreferrer">
                  {t.contact.linkedin} <span>&rarr;</span>
                </a>
              </div>
            </div>
